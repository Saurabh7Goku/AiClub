      ...
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-12 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-16 relative z-10">
        ...
        >
          ...
          <div className="hidden sm:grid grid-cols-2 gap-3 w-full max-w-md mx-auto lg:mx-0">
            {[
              { icon: '🔮', label: 'AI Strategy Voting', delay: 0.1 },
              { icon: '📡', label: 'Live Data Feeds', delay: 0.2 },
              { icon: '🤝', label: 'Real-time Rooms', delay: 0.3 },
              { icon: '✨', label: 'Smart AI Drafts', delay: 0.4 },
            ].map((feature, idx) => (
              <motion.div
        ...
        >
          ...
          <div className="backdrop-blur-xl bg-black/40 border border-white/10 rounded-[32px] p-8 sm:p-10 shadow-2xl relative overflow-hidden">
            ...
            <div className="mb-8 text-center sm:text-left">
              ...
              <p className="text-gray-400 mt-2 text-sm font-medium">Verify your credentials to continue.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between px-1">
                  ...
                  <Link href="/forgot-password" className="text-[11px] font-bold text-accent-400 hover:text-accent-300 transition-colors uppercase tracking-wider">
                    Recover?
                  </Link>
                </div>
                <input
                  ...
                  className="w-full bg-black/50 border border-white/10 text-white rounded-2xl px-5 py-4 text-sm outline-none focus:border-accent-500/50 focus:ring-2 focus:ring-accent-500/20 transition-all placeholder:text-gray-600 tracking-widest font-mono"
                  placeholder="••••••••••••"
                />
              </div>
            ...
            <button
              ...
              disabled={loading || googleLoading}
              className="mt-8 w-full py-4 rounded-2xl bg-white/[0.03] hover:bg-white/[0.08] border border-white/10 text-white font-semibold text-sm transition-all flex items-center justify-center gap-3 disabled:opacity-50"
            >
              {googleLoading ? (
            ...
            <p className="mt-8 text-center text-gray-400 text-sm font-medium">
              ...
              <Link href="/signup" className="text-white font-bold hover:text-accent-400 transition-colors underline underline-offset-4 decoration-white/20 hover:decoration-accent-500/50">
                Apply for Access
              </Link>
            </p>
